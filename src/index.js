...
// NOTE: this isn't ES*-compliant/possible, but works because we use Webpack as
// a build tool
...
export const renderApp = (state, callback = () => {}) => {
    ...
    </Router>, document.getElementById('app'), callback);
};
        ...
        state = {
            ...
            ...{
                user: {
                    ...
                    id: renderUser.id,
                    profilePicture: render.profilePicture,
                    authenticated: true
                },
                token
            }
